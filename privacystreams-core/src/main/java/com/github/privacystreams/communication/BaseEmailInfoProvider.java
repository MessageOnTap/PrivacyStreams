...
abstract public class BaseEmailInfoProvider extends MStreamProvider {
     ...
     */
    public BaseEmailInfoProvider(String apiKey, String secretKey) {
        this.mApiKey = apiKey;
    ...
    public List<EmailInfoEntity> listEmailInfoEntity(String username, Date lastUpdateTime, Integer offset, Integer limit) throws JSONException {
        ...
        try {
            results = new BaseEmailInfoProvider.FetchEmailInfoTask().execute(params).get();
